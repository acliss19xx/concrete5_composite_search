...
namespace Application\Block\CompositeSearch;
...
{
    protected $btTable = 'btCompositeSearch';
    ...
    public function save($data)
    {
        ...
        $args['attributeKeys'] = json_encode($data['attributeKeys'], JSON_PRETTY_PRINT );
